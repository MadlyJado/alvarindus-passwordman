...
function EmailAndPass() {
  ...
  return (
    ...
    <button type="submit" disabled={isLoading} className="btn btn-primary btn-lg btn-wide shadow-lg hover:scale-105 transform transition-all duration-300 w-full">
