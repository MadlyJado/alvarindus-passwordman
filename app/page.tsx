...
export default function Home() {
  return (
    <div className="bg-[url('/lib/Jadons Pattern.png')]  min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-950 to-indigo-700 text-white p-4">
